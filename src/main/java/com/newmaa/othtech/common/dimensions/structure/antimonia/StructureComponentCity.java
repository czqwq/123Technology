...
public abstract class StructureComponentCity extends StructureComponent {
    ...
    protected StructureStartPiecesAntimoniaCity startPiece;

    public StructureComponentCity() {}

    protected StructureComponentCity(StructureStartPiecesAntimoniaCity par1ComponentVillageStartPiece, int par2) {
        super(par2);
    ...
    protected StructureComponent getNextComponentNN(StructureStartPiecesAntimoniaCity par1ComponentVillageStartPiece,
        List<StructureComponent> par2List, Random par3Random, int par4, int par5) {
        return switch (this.coordBaseMode) {
            case 0 -> StructureCityPiecesAntimonia.getNextStructureComponent(
            ...
            case 1 -> StructureCityPiecesAntimonia.getNextStructureComponent(
                par1ComponentVillageStartPiece,
                par2List,
                par3Random,
                ...
                2,
                this.getComponentType());
            case 2 -> StructureCityPiecesAntimonia.getNextStructureComponent(
                par1ComponentVillageStartPiece,
                par2List,
                par3Random,
                this.boundingBox.minX - 1,
                ...
                1,
                this.getComponentType());
            case 3 -> StructureCityPiecesAntimonia.getNextStructureComponent(
                par1ComponentVillageStartPiece,
                par2List,
                par3Random,
                this.boundingBox.minX + par5,
    ...
    protected StructureComponent getNextComponentPP(StructureStartPiecesAntimoniaCity par1ComponentVillageStartPiece,
        List<StructureComponent> par2List, Random par3Random, int par4, int par5) {
        return switch (this.coordBaseMode) {
            case 0 -> StructureCityPiecesAntimonia.getNextStructureComponent(
                par1ComponentVillageStartPiece,
